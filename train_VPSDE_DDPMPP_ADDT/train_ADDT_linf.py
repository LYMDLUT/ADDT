        ...
        for step, batch in enumerate(train_dataloader):
            ...
            for _ in range(5):
                ...
                for _ in range(1):
                    ...
                    noisy_images = mean_vp + std[:, None, None, None] * (noise + delta * ratio)
                ...
                d = clamp(d, lower_limit - clean_images, upper_limit - clean_images)
                delta.data = d
            ...
            with accelerator.accumulate(model):
                ...
                with accelerator.autocast():
                    noise_pred = model(noisy_images, scaled_t)
                    losses = torch.square(-noise_pred + noise + delta * ratio)
