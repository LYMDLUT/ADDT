...
import diffusers
from diffusers import DDPMPipeline, DDPMScheduler, UNet2DModel,DiffusionPipeline,ImagePipelineOutput
...
def main(args):
    ...
    for epoch in range(first_epoch, args.num_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            mean, std = noise_scheduler.marginal_prob(clean_images, timesteps)
            noisy_images = mean + std[:, None, None, None] * noise
