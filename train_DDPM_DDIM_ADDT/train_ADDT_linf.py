...
def main(args):
    ...
    for epoch in range(first_epoch, args.num_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            ratio = (sqrt_alpha_prod/sqrt_one_minus_alpha_prod).clip(0,10)
            ...
            for _ in range(5):
                ...
                for _ in range(1):
                    ...
                    noisy_images, sqrt_alpha_prod, sqrt_one_minus_alpha_prod = noise_scheduler.add_noise(clean_images, noise + delta * ratio[:,None,None,None], timesteps)
                ...
                d = clamp1(d, lower_limit - clean_images, upper_limit - clean_images)
                delta.data = d
            ...
            with accelerator.accumulate(model):
                ...
                if args.prediction_type == "epsilon":
                    loss = F.mse_loss(model_output, noise + delta * ratio[:,None,None,None])  # this could have different weights!
