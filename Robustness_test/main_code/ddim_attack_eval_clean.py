...
logger.add(f"../../clean_result/{FLAGS.save_folder}/{FLAGS.model_type}/ddim/log_test_ddim_clean_t_{Denoise_strength}_step_{Num_inference_steps}_|{model_id.split('/')[-1]}|_bs_{batch_size}_num_test_{num_test}.log")
