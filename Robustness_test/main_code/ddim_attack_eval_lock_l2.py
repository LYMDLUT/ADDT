...
logger.add(f"../../result/{FLAGS.save_folder}/ddim_l2_lock/{FLAGS.model_type}/log_test_ddim_t_{Denoise_strength}_step_{Num_inference_steps}_|{model_id.split('/')[-1]}|_bs_{batch_size}_num_test_{num_test}_pgd_{pgd_step}_eot_{eot_step}.log")
