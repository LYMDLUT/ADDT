...
logger.add(f"../../clean_result/{FLAGS.save_folder}/{FLAGS.model_type}/ddpm/log_test_fix_{FLAGS.fix_type}_ddpm_t_{Denoise_strength}_step_{Num_inference_steps}_|{model_id.split('/')[-1]}|_bs_{batch_size}_num_test_{num_test}.log")
...
for sample_image, y_val in tqdm(cifar10_test_loader, colour='yellow'):
    ...
    del images_1, images_2, yy, noisy_image, adv_out, noise, sample_image, y_val
